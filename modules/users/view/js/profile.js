...
document.all("alerta").style.visibility="visible";
timerID=setTimeout("ocultarMensaje()",500);

}

function ocultarMensaje(){
document.all("alerta").style.visibility="hidden";
             ...
             function fill() {
               ...
               $.post(amigable('?module=users&function=profile_filler'), {userJSON: dataJSON},
                  ...
                  //  console.log(response);
                    ...
                    /*  dataJSON = JSON.stringify({ruta_avatar: response.user['avatar']});
                      $.post(amigable('?module=users&function=cargarAvatar'), {avatar_json: dataJSON},
